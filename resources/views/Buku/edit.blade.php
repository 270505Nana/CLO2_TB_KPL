      ...
      <div class="row">
        <div class="col-md-12 mr-3 ml-3">
          <div class="card">
            ...
            {{--CARD FORM  --}}
            <form id="form-buku" action="{{ route('buku.update', $buku->id) }}" method="POST">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="penerbit" value="{{ old('penerbit', $buku->penerbit) }}" placeholder="Masukkan Penerbit" id="penerbit" required>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="tahun_terbit" min="1900" max="2099" step="1" class="form-control" value="{{ old('tahun_terbit', $buku->tahun_terbit) }}" placeholder="Masukkan Tahun Terbit" id="tahun_terbit" required>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="genre" class="form-control" value="{{ old('genre', $buku->genre) }}" placeholder="Masukkan Genre Buku" id="genre" required>
                </div>
            </div>
        </div>
        <!-- Tombol Submit -->
