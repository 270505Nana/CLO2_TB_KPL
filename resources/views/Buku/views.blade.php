      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Tables Buku</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Tables Buku</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0">
              ...
              <a class="btn btn-success btn-sm ms-auto" href="/tambahdatabuku">Tambah Buku</a>
            </div>
