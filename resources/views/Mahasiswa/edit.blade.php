          ...
          <div class="card">
            ...
            <div class="card-header pb-0">
              ...
              <div class="d-flex align-items-center">
                ...
                <button type="submit"  form="form-mahasiswa"  class="btn btn-success btn-sm ms-auto">Update Data Mahasiswa</button>
              </div>
            </div>

            {{--CARD FORM  --}}
            <form id = "form-mahasiswa" action="{{ route('mahasiswa.update', $mhs->nim) }}" method="POST">
              @csrf
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="nim" class="form-control" value="{{ old('nim', $mhs->nim) }}" required>
                    </div>
                  </div>
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="nama" placeholder="Masukkan Nama Mahasiswa" id="nama" required value="{{ old('nama', $mahasiswa->nama) }}">
                    @error('nama')
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="nim" placeholder="Masukkan NIM Mahasiswa" id="nim" required value="{{ old('nim', $mahasiswa->nim) }}" min="1000000000">
                    @error('nim')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="fakultas" class="form-control" placeholder="Masukkan Fakultas Mahasiswa" required value="{{ old('fakultas', $mahasiswa->fakultas) }}">
                    @error('fakultas')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="prodi" class="form-control" placeholder="Masukkan Program Studi Mahasiswa" required value="{{ old('prodi', $mahasiswa->prodi) }}">
                    @error('prodi')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="angkatan" class="form-control-label">Angkatan/Tahun Masuk Mahasiswa</label>
                    <input type="number" name="angkatan" class="form-control" placeholder="Masukkan Tahun Masuk Mahasiswa" required value="{{ old('angkatan', $mahasiswa->angkatan) }}" min="2000">
                    @error('angkatan')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="nomor_hp" class="form-control-label">Nomor Handphone Mahasiswa</label>
                    <input type="number" name="nomor_hp" class="form-control" placeholder="Masukkan Nomor Telepon Mahasiswa" required value="{{ old('nomor_hp', $mahasiswa->nomor_hp) }}" min="1000000000">
                    @error('nomor_hp')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="card-footer d-flex justify-content-end">
        <button type="submit" class="btn btn-success">Update Data Mahasiswa</button>
    </div>
</form>
