  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" name="id_buku" id="id_buku" required>
                    ...
                    @foreach($buku as $b)
                        <option value="{{ $b->id }}" {{ (old('id_buku', $peminjaman->id_buku ?? '') == $b->id) ? 'selected' : '' }}>
                            {{ $b->judul }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="nim" id="nim" required>
                    ...
                    @foreach($mahasiswa as $m)
                        <option value="{{ $m->nim }}" {{ (old('nim', $peminjaman->nim ?? '') == $m->nim) ? 'selected' : '' }}>
                            {{ $m->nama }}
                        </option>
                    @endforeach
                </select>
    ...
    <div class="text-end mt-3">
        <button type="submit" class="btn btn-success">
            {{ isset($peminjaman) ? 'Update Data' : 'Tambah Data' }}
        </button>
    </div>
